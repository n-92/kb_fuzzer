...
{
    const char charset[] = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 öäå½§`~!@#$%^&*()-_=+[]{};:\'\",.<>/?";
    if (size) {
        --size;
...
static int32_t bad_kb_worker(void* context) {
    ...
    /*N92: Custom code to spam the crap out of target. */
    while (1) {
        int upper = 10;
        int lower = 1;
        int random_length = (rand() %(upper - lower + 1)) + lower;
        char* s = malloc(random_length);
        ducky_string(bad_kb, rand_string(s, random_length));
        furi_hal_hid_kb_press(HID_KEYBOARD_RETURN);
        ...
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F2);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F3);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F4);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F5);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F6);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F7);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F8);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F9);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F10);
        //furi_hal_hid_kb_release_all();
        //furi_hal_hid_kb_press(HID_KEYBOARD_F11);
        //furi_hal_hid_kb_release_all();
